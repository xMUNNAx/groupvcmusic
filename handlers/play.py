...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    draw.text(
        (190, 590), f"Dʋʀʌtɩoŋ : {duration}", (255, 255, 255), font=font
    )
...
async def play(_, message: Message):
    ...
    if message.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        photo="final.png", 
        caption=f"#⃣ Yoʋʀ ʀɘqʋɘstɘɗ soŋʛ **queued** ʌt posɩtɩoŋ {position}!",
        ...
        photo="final.png",
        reply_markup=keyboard,
        caption="▶️ **Pɭʌƴɩŋʛ** ʜɘʀɘ tʜɘ soŋʛ ʀɘqʋɘstɘɗ ɓƴ {} vɩʌ YoʋTʋɓɘ 🎵".format(
